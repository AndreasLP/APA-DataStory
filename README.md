...
For example, for democrats in 2015, the words that represented the election's topic were mostly about primary elections and potential republican candidates such as [Donald Trump](https://en.wikipedia.org/wiki/Donald_Trump), [Marco Rubio](https://en.wikipedia.org/wiki/Marco_Rubio), [Paul Ryan](https://en.wikipedia.org/wiki/Paul_Ryan), [Jeb Bush](https://en.wikipedia.org/wiki/Jeb_Bush). For republicans, the topic of elections in 2015 was also containing terms about potential democratic candidates for the first round of presidential elections: [Hilary Clinton](https://en.wikipedia.org/wiki/Hillary_Clinton), [Elizabeth Warren](https://en.wikipedia.org/wiki/Elizabeth_Warren), an interesting bigram from the most common terms was *beat Hilary*. We notice as well, that [Donald Trump](https://en.wikipedia.org/wiki/Donald_Trump) for democrats and [Hilary Clinton](https://en.wikipedia.org/wiki/Hillary_Clinton) for republicans, were already the biggest opponents as they lead in the number of occurences in the topic of elections in 2015. 
In 2016, the election's topic mostly focuses on the second round of elections, for democrats, on Hilary Clinton as she is the candidate with the most potential to win the elections. The same goes from the republicans, where the focus is on Donald Trump. 
After the official results of the second round of elections and the winning of [Donald Trump](https://en.wikipedia.org/wiki/Donald_Trump) in late 2016, in 2017 we notice that the focus on the election's topic for democrats is mainly on president Trump. Some words that occur often in the topic are *investigation*, *security*, *Russia*. For the republicans, a.k.a the winners, the most common word are *lose election*, *win*, *Russia*. 
